 ...
 *
 */
public class TestRunnerApplicationContext extends GenericApplicationContext{
    public TestRunnerApplicationContext(){
    ...
    public void initialiseWithProjectId(String projectId){
        UserContext userContext = this.getBean(UserContext.class);
