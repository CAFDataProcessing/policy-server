 ...
 *
 *
 * This class joins other Conditions together with an AND or OR operation on each.
 */
@JsonIgnoreProperties({ApiStrings.Conditions.Arguments.DESC,ApiStrings.Conditions.Arguments.VALUE,ApiStrings.Conditions.Arguments.LANGUAGE,ApiStrings.Conditions.Arguments.CONDITION,ApiStrings.Conditions.Arguments.FIELD})
