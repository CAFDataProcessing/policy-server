...
/**
 * Class to represent the exception details that is sent to the client. It will attempt to remove any exception types
 * from the start of the error message so inner workings/severity are not directly exposed.
 */
class ErrorResponse{
    @JsonProperty("error")
    public Number error;
