...
import com.github.cafdataprocessing.corepolicy.hibernate.HibernateExecutionContextProviderImpl;
...
/**
 * Listens to ContextLoader and performs operations as required
 */
public class ContextLoaderListener extends ContextLoader implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        logger.trace("CorePolicy ContextLoaderListener contextInitialized");
    ...
    public void contextDestroyed(ServletContextEvent servletContextEvent) {
        ...
        logger.trace("CorePolicy ContextLoaderListener contextDestroyed");
    ...
    private void closeApplicationObjects() {
        ...
        // only get and shutdown the execution context if the bean has already been registered/created!
        if (applicationContext.containsBean(HibernateExecutionContextProviderImpl.class.getName())) {
