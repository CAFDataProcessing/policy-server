...
/**
 * Web implementation of the ClassificationApi that goes to Java WS.
 */
public class ClassificationApiJavaImpl extends ClassificationApiWebBase {

    private UserContext context;

    @Autowired
    public ClassificationApiJavaImpl(UserContext context, ApiProperties apiProperties) {
        super(apiProperties);
