...
public interface EnvironmentInitializer {
    EnvironmentSnapshotImpl initialize(EnvironmentSnapshotImpl environmentSnapshot);
    EnvironmentSnapshotImpl remove(EnvironmentSnapshotImpl environmentSnapshot);
}
